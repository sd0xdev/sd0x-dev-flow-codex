...
- [ ] R3 transaction inputs are ready to bind payload、spec and disposition in a `pack-ready` record after docs review and fresh deterministic verification on the resulting Completed-request fingerprint.
- [ ] Pack handoff notes the separation from the core `review` runtime gate.
